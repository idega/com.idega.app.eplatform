 ...
 ************************************************/
// $Id: UnixNetscapeBrowserLaunching.java,v 1.1 2007/12/11 02:35:40 eiki Exp $
...
public class UnixNetscapeBrowserLaunching
     ...
     */
    protected Map unixBrowsers = new TreeMap(String.CASE_INSENSITIVE_ORDER);

    protected final AbstractLogger logger; // in ctor
    /**
     * name of config file passed into constructor
     */
    protected final String configFileName; // in ctor
    /**
